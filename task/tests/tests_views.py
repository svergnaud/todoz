...
from task.views import CategoryListView, home_page, TodoView
...
class HomePageTest(TestCase):
    ...
    def test_home_page_html(self):
        ...
        assert content.endswith(b'</html>\n'), 'Le contenu ne se termine pas par </html>'
    ...
    def test_base_template_is_used(self):
        ...
        assert ['task/home.html', 'task/base.html'] == templates_used, templates_used
...
class CategoryListTest(TestCase):
    ...
    def test_url_resolve_to_category_list_view2(self):
    ...
    def test_template(self):
        ...
        assert 'task/category_list.html' in templates
...
class TodoViewTest(TestCase):
    ...
    def test_template(self):
        response = self.client.get(self.url)
        templates = [t.name for t in response.templates]
        assert 'task/todo.html' in templates
